...
class FactExtractionResult(BaseModel):
    ...
    product_or_service: str = Field(
        description="The specific product or service in dispute (e.g., 'SUV', 'domestic flight ticket', 'UPSC course','Online delivery','Online Service')."
    )
    ...
    evidence_available: List[str] = Field(
        default=[], 
        description="List of evidence items mentioned (e.g. invoice, emails, service reports, photos,customer chats,bills)."
    )
